...
<com:TRepeater ID="GroupTable" OnItemCommand="onDeleteGroup" >
	...
	<prop:ItemTemplate>
		<tr class="row1">
			...
			<td><com:TLinkButton class="warning" Text="削除" CommandName="delete" CommandParameter="#$this->Parent->Data['id']" onclick="if(!confirm('Are you sure?')) return false;"/></td>
		</tr>
	</prop:ItemTemplate>
...
<com:TPanel ID="ConfirmationPanel" Visible="false" >
	<h3 class="message">グループを削除しました！</h3>
